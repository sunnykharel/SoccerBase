...
@app.route("/getnews/<string:topic>", methods=["GET"])
def get_news(topic):
    ...
    topHeadlines = newsClient.get_top_headlines(q = topic + "soccer", category="sports", language="en")
